from op_dispatcher.constants import SKIPPING_CONSTANTS, SYMBOLS_IN_TECH_DATA_MAPPINGS
from op_dispatcher.common.helpers.common_helpers import get_index_from_string
