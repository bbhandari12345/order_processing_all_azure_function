from op_netsuite_fetcher.constants import SKIPPING_CONSTANTS, SYMBOLS_IN_TECH_DATA_MAPPINGS
from op_netsuite_fetcher.common.helpers.common_helpers import get_index_from_string
